      ...
      <header className="w-full border-b bg-white/90 backdrop-blur supports-[backdrop-filter]:bg-white/60">
        <div className="container mx-auto flex items-center justify-between py-4">
          <Link
            ...
            aria-label="HealthyLife Community Clinic Home"
          >
            <div
          ...
          <nav aria-label="Main" className="hidden md:flex items-center gap-2">
            ...
            <NavLink to="/booking" active={isActive("/booking")}>
              Find a Doctor
            </NavLink>
          </nav>
        ...
        {open && (
          <div
            id="mobile-menu"
            className="md:hidden bg-white border-b shadow-sm"
          >
        ...
        <div className="container mx-auto py-8 grid gap-4 md:grid-cols-3">
          <div>
            ...
            <p className="text-sm mt-2 max-w-sm">
              Patient-first care with accessible, secure, and ethical design. We
          ...
          <div>
            ...
            <p className="text-sm mt-2 flex items-start gap-2">
              ...
              Secure payments and encrypted data storage.
            </p>
          </div>
...
function NavLink({
  ...
  return (
    <Button
      ...
      size="sm"
      className={cn("text-sm", active ? "" : "text-foreground")}
    >
...
function NavLinkMobile({
  ...
  return (
    <Link
      ...
      onClick={onClick}
      className={cn(
        "w-full text-left text-base font-medium px-3 py-2 rounded-md",
