...
export default function Confirm() {
  ...
  const discount =
    service === "Telehealth Appointment" && quantity >= 3
      ? 0.1 * (pricePer * quantity)
      : 0;
  ...
  const validate = () => {
    ...
    if (!/^(0[1-9]|1[0-2])\/(\d{2})$/.test(expiry))
      e.expiry = "Enter expiry in MM/YY";
  ...
  return (
    <div className="container py-8">
      ...
      <p className="mt-2 text-muted-foreground">
        Confirm details and pay securely. Card details are encrypted and never
        stored.
      </p>
        ...
        <Card>
          <CardContent className="p-4 md:p-6">
            ...
            <dl className="mt-3 grid gap-2">
              ...
              <div className="mt-3">
                <span className="inline-block px-2 py-1 rounded-full bg-secondary text-secondary-foreground text-sm">
                  {service === "Telehealth Appointment"
                    ? "Telehealth"
                    : "In-person"}
                </span>
              </div>
              ...
              <div className="grid gap-2 mt-3">
                ...
                <select
                  ...
                  className="h-10 rounded-md border border-input bg-background px-3 w-24"
                >
              ...
              <div className="mt-4 grid gap-1">
                ...
                {discount > 0 && (
                  <div className="mt-2 p-2 bg-green-50 border border-green-100 rounded-md text-sm text-green-800">
                    Telehealth bundle discount (10%) applied: -
            ...
            <div className="mt-4">
              ...
              <p className="text-sm text-muted-foreground">
                If you registered, these fields will be prefilled. You can edit
                them here for this booking.
              </p>
              ...
              >
                ...
                <div className="mt-3 flex items-start gap-2">
                  ...
                  <label htmlFor="consent" className="text-sm">
                    I consent to HealthyLife storing my patient details securely
                    and agree to the{" "}
                ...
                <div className="flex items-start gap-2">
                  ...
                  <label htmlFor="tips" className="text-sm">
                    Email me health tips & appointment reminders.
                  </label>
                </div>
                ...
                <p className="mt-3 text-sm text-muted-foreground">
                  A confirmation email will be sent with your booking details
                  and receipt.
                </p>
              </form>
            </CardContent>
